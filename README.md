...
Pushing a version tag such as `v0.1.2-rc2` publishes two multi-platform images to
...
```sh
curl -fsSL https://raw.githubusercontent.com/INP146/ArchiveX/v0.1.2-rc2/docker-compose.ghcr.yml -o ./docker-compose.yml
```
...
scheduler, and `tools` all use the backend image. It pins version `0.1.2-rc2`
